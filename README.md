# Geass Translation
## Setup
Create a "GeassData" folder and copy the rom as "geass.nds" in it.  
...
## Run from binary
Download the latest [release](https://github.com/Illidanz/GeassTranslation/releases) outside the data folder.  
...
## Text Editing
Rename the \*\_output.txt files to \*\_input.txt (db_output.txt to db_input.txt, etc) and add translations for each line after the `=` sign.  
